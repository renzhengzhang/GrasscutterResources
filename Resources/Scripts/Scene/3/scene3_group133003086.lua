...
-- 变量
variables = {
	{ config_id = 1, name = "is_TutorialOver", value = 0, no_refresh = true },
	{ config_id = 2, name = "from_north", value = 0, no_refresh = false },
	{ config_id = 3, name = "from_south", value = 0, no_refresh = false }
}
