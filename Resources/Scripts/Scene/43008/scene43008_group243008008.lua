...
-- 装置
gadgets = {
	{ config_id = 8003, gadget_id = 70360156, pos = { x = -36.300, y = 40.000, z = -28.300 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 },
	{ config_id = 8019, gadget_id = 70900205, pos = { x = 25.499, y = 32.453, z = -3.059 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 8010, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 60.000 }, pos = { x = -26.500, y = 40.000, z = -29.500 } }
}
...
-- 点位
points = {
	{ config_id = 8002, pos = { x = -29.948, y = 40.049, z = -36.636 }, rot = { x = 0.000, y = 336.139, z = 0.000 } },
	{ config_id = 8006, pos = { x = -37.985, y = 40.000, z = -36.718 }, rot = { x = 0.000, y = 10.631, z = 0.000 } },
	{ config_id = 8007, pos = { x = -41.844, y = 40.000, z = -23.107 }, rot = { x = 0.000, y = 116.679, z = 0.000 } },
	{ config_id = 8008, pos = { x = -31.378, y = 40.002, z = -19.670 }, rot = { x = 0.000, y = 212.681, z = 0.000 } },
	{ config_id = 8009, pos = { x = -27.942, y = 40.000, z = -25.945 }, rot = { x = 0.000, y = 265.064, z = 0.000 } },
	{ config_id = 8011, pos = { x = -29.948, y = 40.049, z = -36.636 }, rot = { x = 0.000, y = 336.139, z = 0.000 } },
	{ config_id = 8012, pos = { x = -37.985, y = 40.000, z = -36.718 }, rot = { x = 0.000, y = 10.631, z = 0.000 } },
	{ config_id = 8013, pos = { x = -41.844, y = 40.000, z = -23.107 }, rot = { x = 0.000, y = 116.679, z = 0.000 } },
	{ config_id = 8014, pos = { x = -31.378, y = 40.002, z = -19.670 }, rot = { x = 0.000, y = 212.681, z = 0.000 } },
	{ config_id = 8015, pos = { x = -27.942, y = 40.000, z = -25.945 }, rot = { x = 0.000, y = 265.064, z = 0.000 } }
}
...
suites = {
	{
		...
		gadgets = { 8003, 8019 },
		regions = { 8010 },
		triggers = { "ANY_MONSTER_DIE_8001", "SELECT_OPTION_8004", "GADGET_CREATE_8005", "LEAVE_REGION_8010", "VARIABLE_CHANGE_8016" },
		rand_weight = 0
	},
	{
		-- suite_id = 2,
