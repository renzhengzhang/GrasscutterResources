...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70360001, pos = { x = 71.363, y = 41.025, z = -29.050 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1 }
}

-- 区域
regions = {
	{ config_id = 1005, shape = RegionShape.CUBIC, size = { x = 50.000, y = 40.000, z = 45.000 }, pos = { x = 65.625, y = 40.000, z = -31.723 } }
}
...
-- 点位
points = {
	{ config_id = 1007, pos = { x = 76.754, y = 40.070, z = -22.712 }, rot = { x = 0.000, y = 213.111, z = 0.000 } },
	{ config_id = 1008, pos = { x = 67.007, y = 40.000, z = -21.619 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1009, pos = { x = 63.542, y = 40.049, z = -28.078 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1010, pos = { x = 68.356, y = 40.049, z = -36.004 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1011, pos = { x = 79.037, y = 40.000, z = -32.329 }, rot = { x = 0.000, y = 321.537, z = 0.000 } },
	{ config_id = 1012, pos = { x = 76.754, y = 40.070, z = -22.712 }, rot = { x = 0.000, y = 213.111, z = 0.000 } },
	{ config_id = 1013, pos = { x = 67.007, y = 40.000, z = -21.619 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1014, pos = { x = 63.542, y = 40.049, z = -28.078 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1015, pos = { x = 68.356, y = 40.049, z = -36.004 }, rot = { x = 0.000, y = 0.000, z = 0.000 } },
	{ config_id = 1016, pos = { x = 79.037, y = 40.000, z = -32.329 }, rot = { x = 0.000, y = 321.537, z = 0.000 } }
}
