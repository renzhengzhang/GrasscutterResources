...
-- 怪物
monsters = {
	{ config_id = 1008, monster_id = 22040201, pos = { x = 2.131, y = 0.192, z = -1.907 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1011, monster_id = 22040201, pos = { x = -2.265, y = 0.192, z = -1.857 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1012, monster_id = 22040201, pos = { x = 4.743, y = 0.192, z = 0.003 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1013, monster_id = 22040201, pos = { x = -5.005, y = 0.192, z = -0.530 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1019, monster_id = 21020701, pos = { x = 0.153, y = 0.192, z = -5.758 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 } },
	{ config_id = 1020, monster_id = 22040201, pos = { x = -0.152, y = 0.192, z = -0.252 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1021, monster_id = 22050201, pos = { x = -0.590, y = 0.073, z = -6.829 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1022, monster_id = 22040201, pos = { x = 2.583, y = 0.192, z = 6.314 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 },
	{ config_id = 1025, monster_id = 22040201, pos = { x = -2.417, y = 0.192, z = 6.991 }, rot = { x = 0.000, y = 180.000, z = 0.000 }, level = 1, disableWander = true, affix = { 1007 }, pose_id = 101 }
}
...
suites = {
	{
		...
		regions = { 1002 },
		triggers = { "ENTER_REGION_1002", "SELECT_OPTION_1003", "CHALLENGE_FAIL_1009", "CHALLENGE_SUCCESS_1010" },
		rand_weight = 100
	},
	{
		-- suite_id = 2,
		-- description = ,
		monsters = { 1008, 1011, 1012, 1013, 1020 },
		gadgets = { },
		regions = { },
	...
	},
	{
		-- suite_id = 3,
		-- description = ,
		monsters = { 1019, 1022, 1025 },
		gadgets = { },
		regions = { },
		triggers = { "CHALLENGE_FAIL_1009", "CHALLENGE_SUCCESS_1010", "ANY_MONSTER_DIE_1028" },
		rand_weight = 100
	},
	{
		-- suite_id = 4,
...
function action_EVENT_ENTER_REGION_1002(context, evt)
	-- 改变指定group组240809001中， configid为1001的gadget的state
	if 0 ~= ScriptLib.SetGroupGadgetStateByConfigId(context, 240809001, 1001, GadgetState.Default) then
	      ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_GroupId_ConfigId")
			return -1
		end

	-- 设置操作台选项
	if 0 ~= ScriptLib.SetWorktopOptionsByGroupId(context, 240809001, 1001, {7}) then
...
function action_EVENT_SELECT_OPTION_1003(context, evt)
	...
	if 0 ~= ScriptLib.SetGadgetStateByConfigId(context, 1001, GadgetState.GearStop) then
	  ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : set_gadget_state_by_configId")
		...
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240809002, suite = 2 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end

	-- 添加suite2的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240809001, 2)

	-- 删除指定group： 240809001 ；指定config：1001；物件身上指定option：7；
	if 0 ~= ScriptLib.DelWorktopOptionByGroupId(context, 240809001, 1001, 7) then
...
function action_EVENT_CHALLENGE_FAIL_1009(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240809002, suite = 1 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
	...
	-- 删除suite2的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 240809001, 2)

	-- 删除suite3的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 240809001, 3)
	...
	-- 删除suite4的所有内容
	    ScriptLib.RemoveExtraGroupSuite(context, 240809001, 4)
...
function action_EVENT_CHALLENGE_SUCCESS_1010(context, evt)
		-- 重新生成指定group，指定suite
		if 0 ~= ScriptLib.RefreshGroup(context, { group_id = 240809002, suite = 0 }) then
	    ScriptLib.PrintContextLog(context, "@@ LUA_WARNING : refresh_group_to_suite")
			return -1
		end
...
function action_EVENT_ANY_MONSTER_LIVE_1023(context, evt)
	...
	if 0 ~= ScriptLib.ActiveChallenge(context, 1, 191, 360, 240809001, 9, 0) then
...
function condition_EVENT_ANY_MONSTER_DIE_1024(context, evt)
	-- 判断指定group组剩余怪物数量是否是3
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240809001) ~= 3 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_1024(context, evt)
	-- 添加suite3的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240809001, 3)
...
function condition_EVENT_ANY_MONSTER_DIE_1028(context, evt)
	-- 判断指定group组剩余怪物数量是否是4
	if ScriptLib.GetGroupMonsterCountByGroupId(context, 240809001) ~= 4 then
		return false
	end
...
function action_EVENT_ANY_MONSTER_DIE_1028(context, evt)
	-- 添加suite4的新内容
	    ScriptLib.AddExtraGroupSuite(context, 240809001, 4)
