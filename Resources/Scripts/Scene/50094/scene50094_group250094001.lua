...
-- 怪物
monsters = {
	{ config_id = 1005, monster_id = 24030301, pos = { x = 0.088, y = 0.000, z = 0.000 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, disableWander = true, affix = { 4181 }, isElite = true, pose_id = 101 }
}
...
-- 装置
gadgets = {
	{ config_id = 1001, gadget_id = 70360010, pos = { x = 0.018, y = -0.153, z = 7.984 }, rot = { x = 0.000, y = 0.000, z = 0.000 }, level = 1, worktop_config = { init_options = { 175 } } },
...
function action_EVENT_SELECT_OPTION_1002(context, evt)
	...
	-- 删除指定group： 250094001 ；指定config：1001；物件身上指定option：175；
