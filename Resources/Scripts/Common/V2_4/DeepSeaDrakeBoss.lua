...
function action_leave_battle_region(context, evt)
	...
	ret1 = ScriptLib.TryReallocateEntityAuthority(context, context.uid, defs.monster_1, evt.param1)
	ret2 = ScriptLib.TryReallocateEntityAuthority(context, context.uid, defs.monster_2, evt.param1)
...
function action_enter_battle_region(context, evt)
    ...
    ret1 = ScriptLib.SetMonsterBattleByGroup(context, defs.monster_1, 155005095)
    ret2 = ScriptLib.SetMonsterBattleByGroup(context, defs.monster_2, 155005095)
