...
function action_VARIABLE_CHANGE_A(context, evt)
	...
	if 1 == evt.param1 - evt.param2 then
		...
		functionParam3 = ScriptLib.GetGroupTempValue(context,actionName .. "Param3",{})
		functionParam4 = ScriptLib.GetGroupTempValue(context,actionName .. "Param4",{})
