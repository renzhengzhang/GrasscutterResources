...
function action_gadget_state_change(context, evt)
	...
	if evt.param1 == 201 and evt.param3 == 0 then
		water = ScriptLib.GetGroupVariableValue(context, "Water_Level")
...
function LF_Check_Water_To_Motion(context, evt)
	up_state = ScriptLib.GetGadgetStateByConfigId(context, 0, defs.gadget_up)
	down_state = ScriptLib.GetGadgetStateByConfigId(context, 0, defs.gadget_down)
	water = ScriptLib.GetGroupVariableValue(context, "Water_Level")
