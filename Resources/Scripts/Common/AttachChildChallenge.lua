...
function LF_Initialize_Level()
	...
	var = {  config_id=50000001,name = Enum.CatchKey, value = 0, no_refresh = false }
...
function AttachChildChallengeFromDiffGroup(context, prev_context, childIndex, challengeId, targetCount)
	...
	fatherIndex = ScriptLib.GetGroupTempValue(context, "ChildChallenge_FatherIndex",{})
	_success = ScriptLib.GetGroupTempValue(context, "ChildChallenge_Success",{})
	_fail = ScriptLib.GetGroupTempValue(context, "ChildChallenge_Fail",{})
	...
	paramTable = {3, 666, targetCount, 1}
	scoreTable = {success = _success,fail = _fail}
...
function AddChildChallengeScore(context, prev_context, score)
	currentScore = ScriptLib.GetGroupVariableValue(context, Enum.CatchKey)
