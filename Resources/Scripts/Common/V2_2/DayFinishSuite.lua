...
--		ScriptLib.PrintContextLog(context,"@@DFS: Get_Suite_By_Finish_State".._suite)
		chestState = ScriptLib.GetGroupVariableValue(context, "chestState")
		chestStateList = retStateByDigit(chestState)
		suite_unfinished_list = {}
