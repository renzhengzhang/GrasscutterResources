...
function LF_ReportSkillExhibition(context)
	...
	for i, v in ipairs(uid_list) do
		resultA = ScriptLib.GetTeamServerGlobalValue(context, v, "SGV_HitByMimik_SkillA")
		resultB = ScriptLib.GetTeamServerGlobalValue(context, v, "SGV_HitByMimik_SkillB")
		hasPickUp = ScriptLib.GetTeamServerGlobalValue(context, v, "SGV_Mimik_PickUped")
